...
<svg {height} {width} viewBox="0 0 48 48">
	<title>Uk Flag</title>
	...
	<g fill="var(--red)">
		<path
			d="M18 18 7 7 5.4 8.8 15 18h3Zm12 0L41 7l1.6 1.8L33 18h-3Zm0 12.2 11 11 1.6-1.8-9.6-9.2h-3Zm-12 0-11 11-1.6-1.8 9.6-9.2h3Z"
		/>
		<path
			d="M.2 21a24.2 24.2 0 0 0 0 6H21v20.8a24.2 24.2 0 0 0 6 0V27h20.8a24.2 24.2 0 0 0 0-6H27V.2C25.8 0 25.2 0 24 0c-1 0-2 0-3 .2V21H.2Z"
		/>
	</g>
</svg>
